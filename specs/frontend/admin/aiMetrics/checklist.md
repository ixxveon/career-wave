...
- 참고: Phase 2 화면 구현은 완료되었고, 단위 테스트는 후속 검증 범위로 남겨 두었다.
...
- [ ] PR은 하나의 Phase 목적만 포함한다. 이번 PR은 Phase 3 구현을 중심으로 하고, Phase 2 체크는 선행 구현 반영 상태를 문서에 동기화한 항목이다.
