...
신고 대상 콘텐츠 블라인드 처리, 신고 기각(DISMISSED), AI 검토, 회원 제재, 콘텐츠 삭제를 포함한다.
...
- 대상 컴포넌트: `frontend/src/admin/pages/Report/ReportPage.tsx`
- 스타일: `frontend/src/admin/styles/Report.css`
- 백엔드 도메인: `admin/report`
- API 계약: `specs/frontend/admin/report/api-schema.md`
