...
- API 계약: `specs/frontend/admin/007-report/api-schema.md`
...
- [ ] Phase 2: API 연동 — `GET /api/admin/reports`, `PATCH /api/admin/reports/{reportId}/blind`, `PATCH /api/admin/reports/{reportId}/dismiss`
