...
- [ ] 사업자등록번호, 대표자명, 기업명, 인증 발급번호 검증 service 구현
...
- [ ] verificationToken purpose/target/channel/expiry/used 검증 구현
- [ ] 인증번호 발송 rate limit 구현: `target + purpose` 기준 60초 재발송 제한, 1시간 5회 제한
