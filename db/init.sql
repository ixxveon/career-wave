...
CREATE TABLE audit_logs (
    ...
    CONSTRAINT chk_log_type   CHECK (log_type  IN ('ADMIN_ACTIVITY', 'ADMIN_MANAGEMENT', 'AI_METRICS_SYSTEM', 'SCRAPING_SYSTEM', 'SETTLEMENT_ACTIVITY', 'PAYMENT_ACTIVITY')),
...
COMMENT ON COLUMN audit_logs.log_type     IS '로그 타입 (ADMIN_ACTIVITY / ADMIN_MANAGEMENT / AI_METRICS_SYSTEM / SCRAPING_SYSTEM / SETTLEMENT_ACTIVITY / PAYMENT_ACTIVITY)';
...
CREATE TABLE ai_usage_logs (
    ...
    CONSTRAINT chk_ai_usage_feature CHECK (feature_type IN ('DOCUMENT', 'INTERVIEW', 'INTERVIEW_STT', 'INTERVIEW_TTS', 'ADMIN_CS', 'ADMIN_REPORT', 'ADMIN_REPORT_MEMBER')),
