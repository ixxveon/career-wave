            ...
            <table className="am-table">
              ...
              {!loading &&
                  applicants.map((applicant) => {
                    ...
                    const stacks = Array.isArray(applicant.stacks) ? applicant.stacks : [];
                        ...
                        <tr key={applicant.id}>
                          ...
                          <td>
                            <div className="am-stacks">
                              {stacks.length > 0 ? (
                                  stacks.map((stack) => (
                                      <span className="am-stack" key={stack}>
                                {stack}
                              </span>
                                  ))
                              ) : (
                                  <span className="am-stack am-stack--empty">-</span>
                              )}
                            </div>
                          </td>

                          <td>
                            <span className="am-score am-score--mid">{applicant.documentScore}</span>
                          </td>

                          <td>
                            <span className="am-score am-score--high">{applicant.interviewScore}</span>
                          </td>
