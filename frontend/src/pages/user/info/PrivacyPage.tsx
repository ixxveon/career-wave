...
function PrivacyPage(): React.ReactElement {
  return (
    <div className="cw-page">
      <div style={{ maxWidth: 1040, margin: '0 auto', padding: '72px 24px', lineHeight: 1.75 }}>
        <h1>개인정보처리방침</h1>

        <p>
          Career Wave는 이용자의 개인정보를 안전하게 보호하고, 개인정보 처리 현황을 투명하게 안내하기
          위해 본 개인정보처리방침을 공개합니다.
        </p>

        <h2>1. 개인정보 처리 목적</h2>
        <p>
          Career Wave는 회원 관리, 본인 확인, AI 서류 분석, AI 면접 코칭, 맞춤 채용공고 추천,
          기업 인증, 결제 처리, 고객 문의 응대 및 서비스 개선을 위해 개인정보를 처리합니다.
        </p>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            <tr>
              ...
              <td style={cellStyle}>이름, 이메일, 휴대전화번호, 로그인 ID, 비밀번호, 회원 유형, 가입일</td>
              <td style={cellStyle}>회원 식별, 로그인, 계정 관리, 본인 확인</td>
              <td style={cellStyle}>회원 탈퇴 시까지</td>
            </tr>
            <tr>
              <td style={cellStyle}>소셜 로그인</td>
              <td style={cellStyle}>OAuth 제공자로부터 전달받는 식별자, 이메일, 프로필 정보</td>
              <td style={cellStyle}>간편 로그인, 계정 연동</td>
              <td style={cellStyle}>연동 해제 또는 회원 탈퇴 시까지</td>
            </tr>
            <tr>
              <td style={cellStyle}>AI 서류 분석</td>
              <td style={cellStyle}>이력서, 자기소개서, 포트폴리오, 분석 요청 내용, AI 피드백</td>
              <td style={cellStyle}>AI 기반 첨삭, 분석 결과 제공, 서비스 품질 개선</td>
              <td style={cellStyle}>회원 탈퇴 시까지 또는 이용자가 삭제 요청 시까지</td>
            </tr>
            <tr>
              <td style={cellStyle}>AI 면접</td>
              <td style={cellStyle}>면접 질문, 답변 내용, 면접 세션 정보, AI 피드백</td>
            ...
            <tr>
              ...
              <td style={cellStyle}>기업 정보, 사업자등록번호, 재직증명서 등 인증 파일</td>
              <td style={cellStyle}>기업 회원 확인, HR 권한 검증</td>
              <td style={cellStyle}>인증 목적 달성 후 관계 법령에 따른 보관 기간까지</td>
            </tr>
            <tr>
              <td style={cellStyle}>결제 및 구독</td>
              <td style={cellStyle}>결제 식별자, 주문번호, 결제 상태, 구독 정보, 환불 처리 정보</td>
              <td style={cellStyle}>유료 서비스 결제, 구독 관리, 환불 및 정산</td>
              <td style={cellStyle}>전자상거래 등 관계 법령에 따른 보관 기간까지</td>
            </tr>
            <tr>
              <td style={cellStyle}>고객 문의</td>
              <td style={cellStyle}>문의 내용, 답변 내용, 이메일, 처리 이력</td>
              <td style={cellStyle}>고객 상담, 분쟁 대응, 서비스 개선</td>
              <td style={cellStyle}>문의 처리 완료 후 관계 법령에 따른 보관 기간까지</td>
            </tr>
          </tbody>
        </table>
        ...
        <p>
          개인정보는 원칙적으로 처리 목적 달성 또는 회원 탈퇴 시 지체 없이 파기합니다. 다만 결제,
          계약, 소비자 분쟁 대응, 접속 기록 등 관계 법령에 따라 보관이 필요한 정보는 해당 법령에서
          정한 기간 동안 보관할 수 있습니다.
        </p>

        <h2>4. 개인정보 파기 절차 및 방법</h2>
        <p>
          보유 기간이 경과하거나 처리 목적이 달성된 개인정보는 복구 또는 재생되지 않도록 안전하게
          파기합니다. 전자적 파일은 복구가 어려운 방식으로 삭제하고, 종이 문서는 분쇄 또는 소각합니다.
        </p>

        <h2>5. 개인정보의 제3자 제공</h2>
        <p>
          Career Wave는 이용자의 사전 동의 없이 개인정보를 외부에 제공하지 않습니다. 다만 법령에
          근거가 있거나 수사기관 등 관계 기관의 적법한 요청이 있는 경우 예외적으로 제공될 수 있습니다.
        </p>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          ...
          <tbody>
            <tr>
              ...
              <td style={cellStyle}>이력서, 자기소개서, 면접 답변, 분석 요청 내용</td>
            ...
            <tr>
              ...
              <td style={cellStyle}>결제 식별자, 주문번호, 결제 상태, 고객 식별 정보</td>
        ...
        <p>
          AI 분석, 클라우드 인프라, 이메일 발송, 결제 처리 등 외부 서비스 이용 과정에서 일부 정보가
          국외에서 처리될 수 있습니다. Career Wave는 필요한 범위 내에서만 정보를 전송하며, 서비스
          제공 목적 외의 용도로 이용하지 않도록 관리합니다.
        </p>

        <h2>8. 정보주체와 법정대리인의 권리 및 행사 방법</h2>
        <p>
          이용자는 언제든지 개인정보 열람, 정정, 삭제, 처리정지를 요청할 수 있습니다. 권리 행사는
          서비스 내 계정 설정, 고객 문의 또는 개인정보 보호책임자 연락처를 통해 요청할 수 있습니다.
        </p>

        <h2>9. 자동 수집 장치 및 쿠키·세션 처리</h2>
        <p>
          Career Wave는 로그인 상태 유지, 보안, 서비스 이용 통계 분석을 위해 쿠키, 세션, 접속 로그,
          기기 정보, IP 주소 등을 처리할 수 있습니다. 이용자는 브라우저 설정을 통해 쿠키 저장을
          거부하거나 삭제할 수 있습니다.
        </p>

        <h2>10. 개인정보 안전성 확보 조치</h2>
        <p>
          Career Wave는 개인정보 보호를 위해 접근 권한 관리, 인증 토큰 기반 접근 제어, 비밀번호
          암호화, 전송 구간 보호, 주요 처리 이력 관리, 파일 접근 제한 등 합리적인 보호 조치를 적용합니다.
        </p>
        ...
        <table style={{ width: '100%', borderCollapse: 'collapse' }}>
          <tbody>
            <tr>
              ...
              <td style={cellStyle}>Career Wave 운영팀</td>
            </tr>
            <tr>
              <th style={cellStyle}>문의 채널</th>
              <td style={cellStyle}>서비스 내 고객 문의 또는 운영팀 이메일</td>
            </tr>
            <tr>
              <th style={cellStyle}>처리 범위</th>
              <td style={cellStyle}>개인정보 열람, 정정, 삭제, 처리정지, 침해 신고 및 고충 처리</td>
            </tr>
          </tbody>
        </table>
        ...
        <p>
          본 개인정보처리방침은 서비스 정책, 법령, 외부 처리 서비스 변경에 따라 개정될 수 있습니다.
          변경 사항은 서비스 화면을 통해 안내하며, 중요한 변경이 있는 경우 시행 전에 공지합니다.
        </p>
