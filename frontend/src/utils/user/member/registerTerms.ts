...
export const personalTermDetails: PersonalTermDetails = {
  service: [
    ...
    },
    {
      ...
      body: '① 이용계약은 회원이 본 약관과 개인정보 수집·이용에 동의하고 회원가입을 완료한 시점에 성립됩니다.\n\n② 개인정보처리방침은 서비스 화면에서 상시 확인할 수 있는 고지 문서입니다.\n\n③ 회사는 회원가입 시 본인 인증 및 실명 확인 절차를 요구할 수 있습니다.\n\n④ 회원은 본인의 정확한 정보를 제공해야 하며 허위 정보 입력에 대한 책임은 회원 본인에게 있습니다.',
    },
    {
      title: '제 5 조 (서비스의 제공)',
  ...
  privacy: [
    {
      ...
      body: '회사는 아래 목적을 위해 서비스 제공에 필요한 최소한의 개인정보를 수집 및 이용합니다.\n\n- 회원가입 및 본인 확인\n- 계정 생성, 로그인, 회원 식별 및 보안 관리\n- AI 기반 맞춤 채용공고 추천\n- AI 면접 및 문서 분석 서비스 제공\n- 채용 지원 및 기업 매칭 서비스 운영\n- 고객 문의 응대 및 공지 전달\n- 서비스 안정성 확보와 부정 이용 방지',
    },
    {
    ...
    {
      title: '4. 동의 거부 권리 안내',
      body: '회원은 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다.\n\n다만 필수 개인정보 수집 및 이용에 동의하지 않을 경우 회원가입 및 기본 서비스 제공이 제한될 수 있습니다.',
    },
    {
      title: '5. 개인정보 보호',
    ...
    {
      title: '6. 동의 철회 방법',
      body: '회원은 관계 법령과 서비스 이용계약에 따라 보관이 필요한 정보를 제외하고, 마이페이지 또는 고객센터 문의를 통해 개인정보 처리 관련 요청을 할 수 있습니다.',
    },
  ],
  marketing: [
    {
      title: '광고성 정보 수신 동의',
      body: '본 동의는 선택 사항이며, 동의하지 않아도 회원가입과 기본 서비스 이용에는 불이익이 없습니다.\n\n회사는 아래 목적을 위해 광고성 정보를 발송할 수 있습니다.\n\n- 신규 서비스 및 기능 안내\n- 이벤트, 프로모션, 제휴 혜택 안내\n- 할인, 쿠폰, 무료 체험 등 혜택 제공\n- 회원 관심 분야에 맞춘 취업 콘텐츠 및 상품 안내\n\n광고성 정보는 이메일, SMS, Push 알림, 카카오 알림톡 등 전자적 전송매체로 발송될 수 있습니다.\n\n회원은 언제든지 마이페이지, 수신설정 관리 또는 고객센터를 통해 광고성 정보 수신 동의를 철회할 수 있습니다.\n\n수신을 거부하거나 철회해도 회원가입과 서비스 이용에는 제한이 없으며, 다만 혜택 및 이벤트 안내를 받지 못할 수 있습니다.',
    },
  ],
};
...
export const companyTermDetails: CompanyTermDetails = {
  ...
  privacy: [
    {
      title: '1. 수집·이용 목적',
      body: '회사는 기업회원 가입, 기업 인증, 담당자 계정 관리, 채용관리 서비스 제공 및 고객 문의 응대를 위해 필요한 개인정보와 기업 인증 정보를 수집·이용합니다.',
    },
    {
      title: '2. 수집하는 개인정보 항목',
      body: '담당자명, 담당자 전화번호, 담당자 이메일, 회사명, 사업자등록번호, 대표자명, 회사 주소, 재직증명서 파일 정보, 서비스 이용 기록, 접속 로그',
    },
    {
      title: '3. 개인정보 보유 및 이용기간',
    ...
    {
      title: '4. 동의 거부 권리 안내',
      body: '기업 담당자는 개인정보 수집 및 이용에 대한 동의를 거부할 권리가 있습니다. 다만 필수 개인정보 및 기업 인증 정보 수집·이용에 동의하지 않을 경우 기업회원 가입 심사와 채용관리 서비스 제공이 제한될 수 있습니다.',
    },
  ],
  marketing: [
    {
      title: '광고성 정보 수신 동의',
      body: '본 동의는 선택 사항이며, 동의하지 않아도 기업회원 가입 심사와 기본 서비스 이용에는 불이익이 없습니다.\n\n회사는 기업회원 담당자에게 신규 기능, 뉴스레터, 기업회원 프로모션, 채용관리 상품 안내, 좌석 구독 플랜 안내, 크레딧 충전 혜택, 제휴 서비스 안내를 제공하기 위해 광고성 정보를 발송할 수 있습니다.\n\n광고성 정보는 이메일, SMS, Push 알림, 카카오 알림톡 등 전자적 전송매체로 발송될 수 있습니다.\n\n광고성 정보 수신 동의는 마이페이지, 광고성 동의 수신 설정 페이지 또는 고객센터를 통해 언제든지 철회할 수 있습니다. 수신을 거부하거나 철회해도 기본 서비스 이용에는 제한이 없으며, 다만 혜택 및 프로모션 안내를 받지 못할 수 있습니다.',
    },
  ],
};
