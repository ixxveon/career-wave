...
import type { CoverLetterFormItem } from '../../../hooks/user/resume/useCoverLetterForm';
import { MAX_COVER_LETTER_ITEMS, MAX_ANSWER_LENGTH } from '../../../utils/user/resume/validation';
