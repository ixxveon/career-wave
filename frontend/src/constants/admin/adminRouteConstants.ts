...
export const ADMIN_ROUTE_ALLOWED_ROLES: Partial<Record<(typeof ADMIN_ROUTE_PATHS)[keyof typeof ADMIN_ROUTE_PATHS], AdminDetailRole[]>> = {
  [ADMIN_ROUTE_PATHS.dashboard]: [
    ...
    ADMIN_DETAIL_ROLE.OPS,
    ADMIN_DETAIL_ROLE.BILLING,
    ADMIN_DETAIL_ROLE.AUDIT,
  ],
  [ADMIN_ROUTE_PATHS.admins]: [ADMIN_DETAIL_ROLE.MASTER],
  [ADMIN_ROUTE_PATHS.members]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.CS, ADMIN_DETAIL_ROLE.OPS],
  [ADMIN_ROUTE_PATHS.reports]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.CS, ADMIN_DETAIL_ROLE.AUDIT],
  [ADMIN_ROUTE_PATHS.cs]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.CS],
  [ADMIN_ROUTE_PATHS.payments]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.BILLING],
  [ADMIN_ROUTE_PATHS.stats]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.OPS, ADMIN_DETAIL_ROLE.BACKEND],
  [ADMIN_ROUTE_PATHS.ai]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.BACKEND],
  [ADMIN_ROUTE_PATHS.scraping]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.BACKEND, ADMIN_DETAIL_ROLE.OPS],
  [ADMIN_ROUTE_PATHS.log]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.AUDIT],
  [ADMIN_ROUTE_PATHS.companies]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.OPS],
  [ADMIN_ROUTE_PATHS.jobNotices]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.OPS],
  [ADMIN_ROUTE_PATHS.settlements]: [ADMIN_DETAIL_ROLE.MASTER, ADMIN_DETAIL_ROLE.BILLING],
};
