...
public interface UserInquiryControllerDocs {
    ...
    @Operation(summary = "내 문의 목록 조회", description = "로그인 회원 본인 문의만 반환. created_at DESC. 페이지네이션 적용.")
    ResponseEntity<ApiResponse<PaginationResponse<SupportDTO.InquiryList>>> getMyInquiries(
