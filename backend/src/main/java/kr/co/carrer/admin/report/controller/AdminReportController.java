...
public class AdminReportController implements AdminReportControllerDocs {
    ...
    public ResponseEntity<ApiResponse<ReportDetailDTO.ResponseProcess>> blindReport(
        ...
        return ResponseEntity.ok(ApiResponse.ok(adminReportService.blindReport(reportId, resolvedAdminId)));
    }
    ...
    public ResponseEntity<ApiResponse<ReportDetailDTO.ResponseProcess>> dismissReport(
        ...
        Long resolvedAdminId = (adminId != null) ? adminId : 1L;
        return ResponseEntity.ok(ApiResponse.ok(adminReportService.dismissReport(reportId, resolvedAdminId)));
    }
