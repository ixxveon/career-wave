...
public class MemberDTO {
    ...
    public record ResponseList(
        ...
        @Schema(description = "역할", allowableValues = {"ROLE_USER", "ROLE_COMPANY"}) RoleType role,
        @Schema(description = "구독 상태", allowableValues = {"FREE", "PREMIUM"}) SubscriptionStatus plan,
        @Schema(description = "계정 상태", allowableValues = {"ACTIVE", "SUSPENDED", "BANNED"}) MemberStatus memberStatus,
