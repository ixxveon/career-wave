...
class ScrapingErrorCode(str, Enum):
    ...
    SCRAPING_DETAIL_COMPLETENESS_FAILED = "SCRAPING_DETAIL_COMPLETENESS_FAILED"
...
ERROR_STATUS_BY_CODE: dict[ScrapingErrorCode, int] = {
    ...
    ScrapingErrorCode.SCRAPING_DETAIL_COMPLETENESS_FAILED: status.HTTP_500_INTERNAL_SERVER_ERROR,
...
DEFAULT_MESSAGE_BY_CODE: dict[ScrapingErrorCode, str] = {
    ...
    ScrapingErrorCode.SCRAPING_DETAIL_COMPLETENESS_FAILED: "All detail scraping requests failed.",
