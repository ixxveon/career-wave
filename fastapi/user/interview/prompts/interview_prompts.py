...
- 존댓말을 사용하세요.
- [중복 금지] 아래 '이미 한 질문 목록'에 포함된 질문과 동일하거나 의미상 유사한 질문을 절대 생성하지 마세요.
- [다양성] 이미 다룬 주제나 키워드를 반복하지 말고 새로운 역량 영역을 탐색하세요.
- [구체성] 지원자의 직전 답변에서 언급된 기술·사례·수치를 활용해 맥락 있는 질문을 생성하세요."""
