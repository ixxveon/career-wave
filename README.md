...
CareerWave는 구직자가 혼자서도 체계적인 취업 준비를 할 수 있도록 돕는 AI 통합 플랫폼입니다.

> _개발 배경 및 기획 의도를 여기에 작성해 주세요._

---

## 2. 주요 화면

> _서비스 주요 화면 스크린샷을 여기에 추가해 주세요._
...
| 아이디 | 비밀번호 | 설명 |
| :--- | :--- | :--- |
| `testuser01` | `Test1234!` | 일반회원 (구독 없음) |
| `testuser02` | `Test1234!` | 일반회원 (면접 구독) |
| `testuser03` | `Test1234!` | 일반회원 (서류 구독) |
| `testuser04` | `Test1234!` | 일반회원 (전체 구독) |
| `testuser05` | `Test1234!` | 일반회원 (정지 계정) |
| `testcompany01` | `Test1234!` | 기업회원 |
